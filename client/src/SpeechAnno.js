...
import { getColumnsByType } from './tableColumns';
...
//   const columns = getColumnsByType('qualityCheck');
  ...
  const handleSelectAudio = useCallback(async (audioId) => {
    ...
    try {
      ...
      setAudioData({
        audioUrl: `http://localhost:9801/api/audio/${audioId}`,
  ...
  return (
    <div className="app-container">
      ...
      <div className="audio-list-container">
        ...
        <AudioList onSelectAudio={handleSelectAudio} />
      </div>
